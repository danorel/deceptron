...
Usage:
    python -m deceptron.tasks.validate --tasks data/deceptron/tasks/tasks.jsonl
    python -m deceptron.tasks.validate --tasks data/deceptron/tasks/tasks.jsonl --force   # re-validate all
"""
...
def main() -> None:
    ...
    parser.add_argument("--repos", default="data/deceptron/mining/repos_verified_clean.jsonl")
