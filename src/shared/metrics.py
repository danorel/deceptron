"""AUROC / pAUROC metrics + bootstrap CIs, shared by `agents.deceptron.eval.main` and
`agents.apollo.eval.main` so both sides of the synthetic-vs-real comparison are
...
# Apollo's pAUROC cutoff (FPR<0.20) — see docs/prior.md. Both eval pipelines
# report pAUROC at this cutoff alongside their own primary cutoff so results
# stay directly comparable to Apollo's published numbers.
APOLLO_MAX_FPR = 0.20
