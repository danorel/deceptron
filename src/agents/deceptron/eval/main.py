"""Evaluate monitor scores — AUROC + pAUROC with bootstrap 95% CIs.

Reports pAUROC at both deceptron's cutoff (FPR<0.05) and Apollo's (FPR<0.20,
docs/prior.md) side by side, so the two are never silently conflated."""
...
def main() -> None:
    ...
    parser.add_argument("--scores", default="data/agents/deceptron/scores/prompted.jsonl")
